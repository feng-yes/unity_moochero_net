...
public class CreateRoomController : MonoBehaviour {
	...
	void Start () {
		lobbyPanelController = lobbyPanel.GetComponent<LobbyPanelController> ();
	}
	...
	public void ClickConfirmCreateRoomButton(){
		...
		RoomInfo[] roomInfos = lobbyPanelController.GetRoomInfos();	//获取游戏大厅内所有游戏房间
