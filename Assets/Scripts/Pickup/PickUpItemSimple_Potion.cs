...
// 疑似这样更改？？
public class PickUpItemSimple_Potion : MonoBehaviourPunCallbacks
{
	...
	public void Pickup()
	{
		...
		this.photonView.RPC("PunPickupSimple", RpcTarget.AllViaServer);	//使用RPC,调用所有玩家的RPC函数PunPickSimple
	}
